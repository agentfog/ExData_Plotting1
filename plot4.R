...
# Open the PNG file graphic device 
png("plot4.png", 480, 480)

# Set up the device to arrange plots in two columns by two rows, filled by columns
par("mfcol" = c(2, 2))

# First plot
plot(x = electricity$TimeStamp, 
     y = electricity$ActivePower,
     type = "l",
     main = "", 
     xlab = "",
